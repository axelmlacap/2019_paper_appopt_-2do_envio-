...
% Our experiments were designed and conducted to study the system behavior considering the above discussed preliminary analysis.
...
\begin{figure}[t!]
	\centering \includegraphics[trim=60 0 50 0, clip, width=.46\textwidth]{figures/RawSignals.pdf}
